...
- 古代の門は開始地点からおよそ32〜48タイル離れた場所に生成
- 門を開くキー遺物はおよそ14〜28タイル圏に生成
- 部品箱はおよそ5〜30タイル、遺跡はおよそ7〜36タイル圏に散在
...
- `rover.js` — Pure Canvas 2D / 128×128 procedural world + recognition memory map / MISSION / 自己アップグレード / 地域進行 / 視覚認識
