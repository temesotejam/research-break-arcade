...
const intro=$("intro"),startButton=$("startButton"),newWarButton=$("newWarButton"),speedButton=$("speedButton");
...
function reset(){
  ...
  running=true;statusText.textContent="RUNNING";intro.hidden=true;
}
