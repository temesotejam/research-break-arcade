...
- 初期支配拠点には4種類の能力を設定し、左右対称に2個ずつ配置
  ...
  - **防衛拠点** — AIだけが追加建設できる。約120pxの射程で接近した敵へ約0.34〜0.52秒間隔の高頻度射撃。1発の威力は低い
- AIは距離だけでなく、損耗・兵力比・補給量・現在方針から「今ほしい拠点能力」を評価して目標を選ぶ
- **AI自律建設拠点** — EMBER / AZURE がそれぞれ1戦に1個だけ追加拠点を自分で建設
  - 通常拠点は補給9、**防衛拠点は補給11、砲撃拠点は補給12**を消費して建設
  - 補給量・損耗率・兵力比・現在方針・性格から **補給 / 医療 / 指揮 / 生産 / 砲撃 / 防衛** のどれを建てるかAIが選択
  - 補給 / 生産は後方寄り、医療は中間、指揮は前線寄り、砲撃は中後方、防衛は本拠点寄りの候補位置を評価
